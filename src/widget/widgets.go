...
func (m *Manager) registerWidgets() {
	widgets := []*Widget{
		...
		// Additional instant answers per IDEA.md
		{Type: WidgetCurrency, Name: "Currency", Description: "Currency conversion", Icon: "dollar-sign", Category: CategoryData, Order: 13},
		{Type: WidgetTimezone, Name: "Timezone", Description: "World time zones", Icon: "globe", Category: CategoryTool, Order: 14},
		{Type: WidgetTranslate, Name: "Translate", Description: "Quick translation", Icon: "language", Category: CategoryData, Order: 15},
		{Type: WidgetWikipedia, Name: "Wikipedia", Description: "Quick Wikipedia summaries", Icon: "book", Category: CategoryData, Order: 16},
		{Type: WidgetTracking, Name: "Package Tracking", Description: "Track packages", Icon: "truck", Category: CategoryData, Order: 17},
		{Type: WidgetNutrition, Name: "Nutrition", Description: "Food nutrition facts", Icon: "apple-alt", Category: CategoryData, Order: 18},
		{Type: WidgetQRCode, Name: "QR Code", Description: "Generate QR codes", Icon: "qrcode", Category: CategoryTool, Order: 19},
		{Type: WidgetTimer, Name: "Timer", Description: "Stopwatch and timer", Icon: "stopwatch", Category: CategoryTool, Order: 20},
		{Type: WidgetLoremIpsum, Name: "Lorem Ipsum", Description: "Generate placeholder text", Icon: "align-left", Category: CategoryTool, Order: 21},
		{Type: WidgetDictionary, Name: "Dictionary", Description: "Word definitions", Icon: "spell-check", Category: CategoryData, Order: 22},
		{Type: WidgetIPAddress, Name: "IP Address", Description: "Your IP address info", Icon: "network-wired", Category: CategoryTool, Order: 23},
		{Type: WidgetColorPicker, Name: "Color Picker", Description: "Color selection tool", Icon: "palette", Category: CategoryTool, Order: 24},
	}
