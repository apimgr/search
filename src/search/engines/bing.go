...
func NewBing() *BingEngine {
	config := models.NewEngineConfig("bing")
...
func (e *BingEngine) Search(ctx context.Context, query *models.Query) ([]models.Result, error) {
	if !e.IsEnabled() {
		return nil, models.ErrEngineDisabled
	}
...
func (e *BingEngine) buildURL(query *models.Query) string {
	params := url.Values{}
...
func (e *BingEngine) parseResults(html string, query *models.Query) ([]models.Result, error) {
