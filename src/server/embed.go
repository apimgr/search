...
type PageData struct {
	...
	CCPAOptedOut bool
	// HasConsentCookie is true when the request carries a valid cookie_consent cookie
...
// Tor and I2P are always present (opt-in features report enabled:false by
// default); GeoIP is a simple non-negotiable bool.
...
// I2PInfo represents I2P eepsite status per AI.md PART 13 / PART 31.2.
