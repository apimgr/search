...
// respondOK writes a JSON success response using the spec-required envelope.
// Per AI.md PART 14: every success response, including single-item results,
// must be {"ok":true,"data":...} — never a bare object.
