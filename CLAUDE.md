...
- TODO.AI.md: 1 pending (`public-help-page-i18n`); `quotes-500-bug` fixed (uncommitted)
- Open uncommitted changes: AI.md, IDEA.md, TODO.AI.md, src/api/{api,api_test,graphql}.go, src/server/server.go, deleted root `client`
- Known structural drift to flag with user: root-level `rootfs/` (forbidden — should be `docker/rootfs/`); `docker/file_system/` instead of `docker/rootfs/`
